const translations = {
  id: {
    ...
    hero: {
      ...
      tagline: "✨ Belajar Bahasa Inggris dengan Percaya Diri",
      titlePrefix: "Belajar Bahasa Inggris dengan ",
      titleHighlight: "Percaya Diri",
      description:
      ...
      btnPrimary: "Lihat Program Kami",
      btnSecondary: "Hubungi Kami",
      whatsappMsg: "Halo! Saya ingin konsultasi tentang program bahasa Inggris di EL's Corner. Mohon informasinya.",
      visualTitle: "Online & Offline",
      visualSub: "Terstruktur • Interaktif • Sesuai Kebutuhan",
      stat1Value: "3 Program",
      stat1Label: "Pilihan Belajar",
      stat2Value: "1-on-1",
      stat2Label: "Kelas Privat",
    },
    home: {
      banner: {
        tag: "BERANDA",
        title: "English for Kids",
        subtitle: "Program bahasa Inggris untuk anak usia sekolah dasar yang dirancang melalui aktivitas interaktif, latihan komunikasi sederhana, dan pembelajaran yang menyenangkan untuk membangun fondasi bahasa Inggris yang kuat sejak dini.",
        cta: "Lihat Program Kami",
        path: "/kids-private",
        bgEmoji: "\u{1F393}",
      },
      features: {
        tag: "Keunggulan Kami",
        title: "Pembelajaran yang Disesuaikan dengan Kebutuhan Siswa",
        subtitle:
          "Setiap siswa memiliki kemampuan, tujuan, dan gaya belajar yang berbeda. Karena itu, pembelajaran disusun bertahap dan menyesuaikan kebutuhan belajar masing-masing siswa.",
        activeTitle: "Fokus pada Penggunaan Bahasa Inggris Secara Aktif",
        activeDesc:
          "Kami percaya bahwa bahasa Inggris akan lebih mudah dikuasai ketika digunakan secara aktif. Melalui latihan berbicara, diskusi, membaca, menulis, dan pengembangan kosakata, siswa didorong untuk memahami sekaligus menggunakan bahasa Inggris dalam berbagai konteks komunikasi sehari-hari.",
        cards: [
          {
            icon: "\u{1F4DA}",
            title: "Pembelajaran yang Disesuaikan",
            desc: "Materi, latihan, dan aktivitas kelas difokuskan untuk membantu siswa mencapai perkembangan yang nyata sesuai kebutuhan belajarnya.",
          },
          {
            icon: "\u{1F4AC}",
            title: "Bahasa Inggris Aktif",
            desc: "Melalui latihan berbicara, diskusi, membaca, menulis, dan pengembangan kosakata, siswa didorong untuk menggunakan bahasa Inggris secara aktif.",
          },
          {
            icon: "\u{1F4F1}",
            title: "Kelas Privat 1-on-1",
            desc: "Untuk program online, pembelajaran dilaksanakan secara privat sehingga setiap sesi dapat berfokus sepenuhnya pada kebutuhan siswa.",
          },
          {
            icon: "\u{1F4BB}",
            title: "Online dan Offline",
            desc: "Siswa dapat mengikuti pembelajaran secara online maupun tatap muka sesuai ketersediaan program dan kebutuhan belajar.",
          },
          {
            icon: "\u{1F4CA}",
            title: "Pemantauan Perkembangan",
            desc: "Setiap siswa menerima evaluasi dan umpan balik perkembangan belajar secara berkala.",
          },
        ],
      },
      programs: {
        tag: "Program Kami",
        title: "Pilih Program yang Sesuai dengan Kebutuhan Belajar Anda",
        subtitle:
          "Program EL’s Course dirancang untuk membantu siswa mengembangkan kemampuan bahasa Inggris secara bertahap melalui pembelajaran yang terarah, interaktif, dan relevan dengan kehidupan sehari-hari.",
        cards: [
          {
            title: "Kids English",
            description:
              "Program bahasa Inggris untuk anak usia sekolah dasar yang dirancang melalui aktivitas interaktif, latihan komunikasi sederhana, dan pembelajaran yang menyenangkan untuk membangun fondasi bahasa Inggris yang kuat sejak dini.",
            category: "Anak",
          ...
          },
          {
            title: "Teens English",
            description:
              "Program bahasa Inggris untuk remaja yang berfokus pada pengembangan grammar, vocabulary, speaking, reading, dan writing secara bertahap.",
            category: "Remaja",
            format: "Online & Offline",
            level: "13 - 18 tahun",
            duration: "4 Minggu",
          ...
          },
          {
            ...
            description:
              "Program bahasa Inggris untuk mahasiswa dan dewasa yang ingin meningkatkan kemampuan komunikasi, grammar, vocabulary, listening, dan speaking dalam konteks umum, akademik maupun profesional.",
            category: "Dewasa",
            format: "Online & Offline",
            level: "19+",
            duration: "4 Minggu",
    ...
    cta: {
      default: {
        ...
        description:
          "Temukan program yang sesuai dengan kebutuhan Anda dan mulai bangun kemampuan bahasa Inggris dengan lebih percaya diri bersama EL’s Course.",
        primaryText: "Lihat Program Kami",
        secondaryText: "Hubungi Kami",
      },
      about: {
        title: "Siap Memulai Perjalanan Belajar Anda?",
        description:
          "Hubungi konsultan kami hari ini dan temukan program yang paling sesuai dengan kebutuhan belajar Anda.",
      },
    },
    footer: {
      brand: "EL's",
      brandHighlight: "Corner",
      description:
        "EL’s Corner menyediakan program pembelajaran bahasa Inggris untuk anak, remaja, dan dewasa melalui pendekatan yang terstruktur, interaktif, dan berfokus pada komunikasi nyata.",
      ...
      programLinks: [
        { name: "Kids English", path: "/programs" },
        { name: "Teens English", path: "/programs" },
        { name: "General English", path: "/programs" },
      ],
      newsletterTitle: "Tetap Terhubung",
      newsletterText:
        "Berlangganan newsletter kami untuk mendapatkan tips belajar, informasi kelas, dan penawaran khusus.",
      ...
      copyright: "EL’s Corner. Hak Cipta Dilindungi.",
      bottomLinks: [
    ...
    about: {
      tag: "Tentang Kami",
      title: "Membantu Anda Belajar Bahasa Inggris dengan Percaya Diri",
      subtitle:
        "El’s Corner lahir dari keyakinan bahwa belajar bahasa Inggris seharusnya menjadi pengalaman yang bermakna, bukan sekadar menghafal aturan dan kosakata.",
      storyTitle: "Cerita dan Misi Kami",
      storyParagraphs: [
        "EL’s Corner didirikan dengan keyakinan bahwa setiap orang dapat belajar bahasa Inggris dengan cara yang lebih nyaman, personal, dan bermakna.",
        "Kami memahami bahwa setiap siswa memiliki kebutuhan, tujuan, dan kecepatan belajar yang berbeda. Karena itu, kami berkomitmen untuk menyediakan pengalaman belajar yang tidak hanya berfokus pada teori, tetapi juga pada praktik, pemahaman, dan perkembangan nyata yang dapat dirasakan oleh setiap siswa.",
        "Misi kami adalah membantu siswa membangun kemampuan bahasa Inggris secara bertahap melalui pembelajaran yang terarah, lingkungan belajar yang positif, dan pendekatan yang mendorong rasa percaya diri dalam berkomunikasi.",
      ],
      visualPaneTitle: "Pembelajaran yang Terarah",
      visualPaneDesc:
        "Setiap program dirancang dengan tujuan belajar yang jelas sehingga siswa dapat berkembang secara bertahap dan terukur sesuai kebutuhannya.",
      valuesTitle: "Nilai-Nilai Kami",
      values: [
        {
          icon: "\u{1F3AF}",
          title: "Pembelajaran yang Terarah",
          desc: "Setiap program dirancang dengan tujuan belajar yang jelas sehingga siswa dapat berkembang secara bertahap dan terukur sesuai dengan kebutuhannya.",
        },
        {
          icon: "\u{1F4AC}",
          title: "Komunikasi sebagai Fokus Utama",
          desc: "Kami mendorong siswa untuk menggunakan bahasa Inggris secara aktif melalui latihan berbicara, diskusi, dan aktivitas yang membantu mereka berkomunikasi dengan lebih percaya diri.",
        },
        {
          icon: "\u{1F4C8}",
          title: "Perkembangan yang Berkelanjutan",
          desc: "Kami percaya bahwa kemajuan dibangun melalui proses yang konsisten. Oleh karena itu, perkembangan siswa dipantau secara berkala untuk membantu mereka mencapai tujuan belajar.",
        },
      ],
      campusTag: "Cara Belajar Bersama Kami",
      campusTitle: "Pembelajaran Online dan Offline",
      campusSubtitle:
        "EL’s Corner menyediakan pilihan kelas online maupun tatap muka untuk memberikan fleksibilitas bagi siswa dalam mengikuti pembelajaran sesuai kebutuhan mereka.",
      campuses: [
        {
          icon: "\u{1F4BB}",
          name: "Online dan Offline",
          desc: "Siswa dapat mengikuti pembelajaran secara online maupun tatap muka sesuai ketersediaan program dan kebutuhan belajar.",
        },
        {
          icon: "\u{1F4DA}",
          name: "Materi yang Relevan dan Interaktif",
          desc: "Setiap sesi dirancang agar siswa dapat belajar secara aktif melalui diskusi, latihan, aktivitas interaktif, dan materi yang relevan dengan kehidupan sehari-hari.",
        },
        {
          icon: "\u{1F91D}",
          name: "Pendekatan yang Personal",
          desc: "Kami berusaha memahami kebutuhan setiap siswa sehingga proses belajar dapat berlangsung dengan lebih nyaman, terarah, dan efektif.",
        },
      ],
    ...
    programsPage: {
      ...
      subtitle:
        "Program EL’s Course dirancang untuk membantu siswa mengembangkan kemampuan bahasa Inggris secara bertahap melalui pembelajaran yang terarah, interaktif, dan relevan dengan kehidupan sehari-hari.",
      filters: ["Semua", "Anak", "Remaja", "Dewasa"],
      programs: [
        {
          title: "Kids English",
          description:
  ...
  en: {
    ...
    hero: {
      ...
      titlePrefix: "Learn English with ",
      titleHighlight: "Confidence",
      description:
        "Online and offline English classes for children, teens, and adults. Build communication skills, confidence, and language ability through structured, interactive learning tailored to your needs.",
      btnPrimary: "View Our Programs",
      btnSecondary: "Contact Us",
      whatsappMsg: "Hello! I would like to inquire about English programs at EL's Corner. Please share the information.",
      visualTitle: "Online & Offline",
      visualSub: "Structured • Interactive • Student-Focused",
      stat1Value: "3 Programs",
      stat1Label: "Learning Paths",
      stat2Value: "1-on-1",
      stat2Label: "Private Classes",
    },
    home: {
      banner: {
        tag: "HOME",
        title: "Learn English with Confidence",
        subtitle: "Online and offline English classes for children, teens, and adults. Build communication skills, confidence, and language ability through structured, interactive learning tailored to your needs.",
        cta: "View English for Kids",
        path: "/kids-private",
        bgEmoji: "\u{1F393}",
      },
      features: {
        tag: "Our Strengths",
        title: "Learning Tailored to Each Student's Needs",
        subtitle:
          "Every student has different abilities, goals, and learning styles. That is why each learning process is arranged step by step to match individual needs.",
        activeTitle: "Focus on Active English Use",
        activeDesc:
          "We believe English is easier to master when it is used actively. Through speaking practice, discussion, reading, writing, and vocabulary building, students are encouraged to understand and use English in everyday communication contexts.",
        cards: [
          {
            icon: "\u{1F4DA}",
            title: "Tailored Learning",
            desc: "Class materials, practice, and activities are focused on helping students make real progress based on their learning needs.",
          },
          {
            icon: "\u{1F4AC}",
            title: "Active English Use",
            desc: "Through speaking, discussion, reading, writing, and vocabulary building, students are encouraged to use English actively in daily contexts.",
          },
          {
            icon: "\u{1F4F1}",
            title: "Private 1-on-1 Classes",
            desc: "For online programs, learning is delivered privately so each session can focus fully on the student’s needs.",
          },
          {
            icon: "\u{1F4BB}",
            title: "Online and Offline",
            desc: "Students can join classes online or in person depending on program availability and learning needs.",
          },
          {
            icon: "\u{1F4CA}",
            title: "Progress Monitoring",
            desc: "Each student receives regular evaluation and feedback so progress can be tracked consistently.",
          },
        ],
      },
      programs: {
        tag: "Our Programs",
        title: "Choose the Program That Fits Your Learning Needs",
        subtitle:
          "EL’s Course programs are designed to help students develop English skills step by step through structured, interactive, and everyday-relevant learning.",
        cards: [
          {
            title: "Kids English",
            description:
              "English for primary school children designed through interactive activities, simple communication practice, and fun learning to build a strong foundation early.",
            category: "Kids",
            format: "Online & Offline",
            level: "Ages 6 - 12",
            duration: "4 Weeks",
            originalPrice: "IDR 299,000",
            price: "IDR 249,000",
            icon: "\u{1F4AC}",
          },
          {
            title: "Teens English",
            description:
              "English for teenagers focused on gradual development of grammar, vocabulary, speaking, reading, and writing skills.",
            category: "Teens",
            format: "Online & Offline",
            level: "Ages 13 - 18",
            duration: "4 Weeks",
          ...
          },
          {
            title: "General English",
            description:
              "English for university students and adults who want to strengthen communication, grammar, vocabulary, listening, and speaking in academic and professional contexts.",
            category: "Adults",
            format: "Online & Offline",
            level: "19+",
            duration: "4 Weeks",
    ...
    cta: {
      default: {
        ...
        description:
          "Find the program that matches your needs and start building your English skills with more confidence at EL’s Course.",
        primaryText: "View Our Programs",
        secondaryText: "Contact Us",
      },
      about: {
        title: "Ready to Start Your Learning Journey?",
        description:
          "Contact our consultants today and find the program that best matches your learning needs.",
      },
    },
    footer: {
      brand: "EL's",
      brandHighlight: "Corner",
      description:
        "EL’s Corner provides English learning programs for children, teens, and adults through a structured, interactive approach focused on real communication.",
      socialAria: { fb: "Facebook", ig: "Instagram", tw: "Twitter", ln: "LinkedIn" },
      ...
      newsletterText:
        "Subscribe to our newsletter for learning tips, class updates, and special offers.",
    ...
    about: {
      tag: "About Us",
      title: "Helping You Learn English with Confidence",
      subtitle:
        "EL’s Corner was founded on the belief that learning English should be a meaningful experience, not just memorizing rules and vocabulary.",
      storyTitle: "Our Story and Mission",
      storyParagraphs: [
        "EL’s Corner was established with the belief that every person can learn English in a way that feels more comfortable, personal, and meaningful.",
        "We understand that every student has different needs, goals, and learning speeds. That is why we are committed to providing a learning experience that focuses not only on theory, but also on practice, understanding, and real progress students can feel.",
        "Our mission is to help students build English skills step by step through structured learning, a positive learning environment, and an approach that encourages confidence in communication.",
      ],
      visualPaneTitle: "Structured Learning",
      visualPaneDesc:
        "Every program is designed with clear learning goals so students can grow gradually and measurably according to their needs.",
      valuesTitle: "Our Values",
      values: [
        {
          icon: "\u{1F3AF}",
          title: "Structured Learning",
          desc: "Every program is designed with clear learning goals so students can grow gradually and measurably according to their needs.",
        },
        {
          icon: "\u{1F4AC}",
          title: "Active English Use",
          desc: "We encourage students to use English actively through speaking practice, discussion, and activities that help them communicate with more confidence.",
        },
        {
          icon: "\u{1F4C8}",
          title: "Sustainable Progress",
          desc: "We believe progress is built through consistent effort. That is why student development is monitored regularly to help them reach their goals.",
        },
      ],
      campusTag: "How We Learn Together",
      campusTitle: "Online and Offline Learning",
      campusSubtitle:
        "EL’s Corner offers both online and in-person classes to give students flexibility in how they learn.",
      campuses: [
        {
          icon: "\u{1F4BB}",
          name: "Online and Offline Classes",
          desc: "Students can join classes online or in person depending on program availability and their learning needs.",
        },
        {
          icon: "\u{1F4DA}",
          name: "Relevant and Interactive Materials",
          desc: "Each session is designed so students can learn actively through discussion, practice, interactive activities, and everyday-relevant materials.",
        },
        {
          icon: "\u{1F91D}",
          name: "Personal Approach",
          desc: "We try to understand each student’s needs so learning can happen in a more comfortable, focused, and effective way.",
        },
      ],
